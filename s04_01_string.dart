...
void main(List<String> args) {
  ...
  String choco = "초코";
  String milk = "우유";
  String chocomilk = choco+milk;
  // 문제 4. 문자열 보간을 이용하여, "초코"와 "우유"를 "초코우유"로 출력하시오.
  String chocomilk2 = '$choco$milk';
  print(chocomilk2);
  ...
  List tempList1 =[];
  List tempList2 =[];
  tempList1 = tempHello1.split("");
  print("tempList1:");
  print(tempList1);
  for (int i = 0; i < tempHello1.length; i++) {
    tempList2.add(tempHello1.substring(i,i+1));
  }
  print("----");
