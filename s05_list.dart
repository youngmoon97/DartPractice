...
void main(List<String> args) {
  ...
  // (인터넷 검색하여 매개변수가 어떤 것이 들어가야 하는지 확인)
  tempList1.sort();
  print(tempList1);
  ...
  String tempString = tempList1.join();
  print(tempString);
  print(tempString.split(""));
  // 문제 9. map을 이용해서 tempList1의 요소를 2배로 만들고 출력하시오.
  // (인터넷 검색하여 매개변수가 어떤 것이 들어가야 하는지 확인)
  print(tempList1.map((e) => e*2));
  // 문제 10. where를 이용해서 tempList1의 짝수만 출력하시오.
  // (인터넷 검색하여 매개변수가 어떤 것이 들어가야 하는지 확인)
  print(tempList1.where((element) => element%2==0));
  // 문제 11. forEach를 이용해서 tempList1의 요소를 반복하고 출력하시오.
  // (인터넷 검색하여 매개변수가 어떤 것이 들어가야 하는지 확인)
  tempList1.forEach((element) { 
    print(element);
  });
  // 문제 12. any를 이용해서 tempList1에 3이 있는지 확인하고 출력하시오.
  print(tempList1.any((element) => element==3));
  // 문제 13. every를 이용해서 tempList1의 모든 요소가 3보다 작은지 확인하고 출력하시오.
  print(tempList1.every((element) => element<3));
  // 문제 14. isEmpty를 이용해서 tempList1이 비어있는지 확인하고 출력하시오.
  print("문제14 :  ${tempList1.isEmpty}");
